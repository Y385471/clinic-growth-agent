...
- [ ] **1. A practice day runs and the owner sees the funnel with its biggest leak**
...
- [ ] **2. Tapping a stage opens its full connected dashboard**
...
- [ ] **3. The receptionist ticks attendance with one tap, and a missed day alerts the owner**
  Becomes usable:
...
- [ ] **4. The agent learns: hypotheses are tested across days, and it names who was lost where**
...
- [ ] **5. It runs by itself every day, handles failures, and live mode is ready for the real page**
  Becomes usable:
