...
الأسماء استبدلت برموز مثل "مريض 103" للخصوصية.
...
إذا كان في learned_from_previous_days فرضية اتأكدت (confirmed) أو اترفضت (rejected)، عدّل النصيحة في مرحلتها بناءً عليها وقول ده صراحة (مثال: "اتأكدنا إن ... فالخطوة الجاية ...").`;
